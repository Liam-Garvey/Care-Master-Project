                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <x-nav-link href="/employees" :active="request()->is('employees')">Employee List</x-nav-link>
                                <x-nav-link href="/employees/create" :active="request()->is('employees/create')">Add Employee</x-nav-link>
                                <x-nav-link href="/companies" :active="request()->is('companies')">Company List</x-nav-link>
                                <x-nav-link href="/companies/create" :active="request()->is('companies/create')">Add Company</x-nav-link>
                            </div>
                        </div>
                    </div>
                    <div class="hidden md:block">
