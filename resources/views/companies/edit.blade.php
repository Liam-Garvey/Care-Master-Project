<x-layout>
    <x-slot:heading>
        Update Company Details: {{ $company->title }}
    </x-slot:heading>
    ...
    <form method="POST" action="/companies/{{ $company->id }}" enctype="multipart/form-data">
            ...
            <div class="border-b border-gray-900/10 pb-12">
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-input name="logo" id="logo" placeholder="Logo" type="file" value="{{ $clogo }}"/>
        ...
        <div class="mt-6 flex items-center justify-between gap-x-6">
            ...
            <div class="flex items-center gap-x-6">
                <a href="/jobs/{{ $company->id }}" class="text-sm font-semibold leading-6 text-gray-900">Cancel</a>
